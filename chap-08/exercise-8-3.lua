...
function with the proper sequence of instructions (r=r..s and s=s..s) and then
use load to produce the final function. Compare the performance of the generic
function (or of a closure using it) with your tailor-made functions.
